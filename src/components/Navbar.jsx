    ...
    return (
        <>
            <div className="nav">
                <div className="nav-left">
                    ...
                    >
                        ...
                        <li>
                            <Link
                                to={
                                    "https://www.firststepahead.in/contact.html"
                                }
                            >
                                Contact
                            </Link>
                ...
                <div
                    className={
                        showMenu ? `nav-right nav-right-mobile` : `nav-right`
                    }
                >
                    <button className="nav-button nav-log-in-button">
                        Log In
                    </button>
                    <button className="nav-button nav-sign-in-button">
                        Sign Up
                    </button>
                </div>
                <div
